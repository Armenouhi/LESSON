    ...
    app.controller("RestoranCtrl", [
        ...
        function($scope, $http, PagerService) {
            ...
            $scope.showHide = function (id) {
                ...
                $scope.restoranDetailId = id;

            };

            $scope.firstRestoranImg = {
                "width" : "300px",
                "height" : "250px",
                "margin-top": "20px"
            };
            ...
            $scope.performSearch = function() {
                ...
                $http
                    ...
                    .then(function(response) {
                        ...
                        vm.itemsToDisplay =  $scope.myFavorite.data.restorans; // array of items to be paged
                        ...
                        function setPage(page) {
                            ...
                            vm.restorents = vm.itemsToDisplay.slice(
                                vm.pager.startIndex,
                                vm.pager.endIndex + 1
                            );
