            ...
            $scope.performSearch = function() {
                ...
                $http
                    ...
                    .then(function(response) {
                        ...
                        vm.itemsToDisplay =  $scope.myFavorite.data.componies; // array of items to be paged

                        console.log($scope.myFavorite.data.componies);
                        ...
                        function setPage(page) {
                            ...
                            vm.scomponies = vm.itemsToDisplay.slice(
                                vm.pager.startIndex,
                                vm.pager.endIndex + 1
                            );
